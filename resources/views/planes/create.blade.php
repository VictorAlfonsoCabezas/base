...
<div class="content">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body col-sm-12">
            <form action="/planes" method="POST" autocomplete="false" autocomplete="off" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row">
                                <section class="col col-sm-12">
                                    <div class="form-group">
                                        <label for="company_name">Nombre del Plan</label>
                                        <input type="text" class="form-control text-uppercase" name="plan_name" id="plan_name" placeholder="Nombre del Plan" required>                
                                    </div>
                                </section>
                                <section class="col col-sm-6">
                                    <div class="form-group">
                                        <label for="ruc">Precio Mensual</label>
                                        <input type="number" class="form-control" name="mensual" id="mensual" placeholder="$0.00" required>                
                                    </div>
                                </section>
                                <section class="col col-sm-6">
                                    <div class="form-group">
                                        <label for="ruc">Precio Anual</label>
                                        <input type="number" class="form-control" name="anual" id="anual" placeholder="$0.00" required>                
                                    </div>
                                </section>
                                <hr class="my-10">
                                <section class="col col-sm-12">
                                ...
                                <section class="col col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="color" class="form-control" name="color_1" id="color_1">                
                                    </div>
                                </section>
                                <section class="col col-sm-4">
                                    <div class="form-group">
                                        <label for="color_2">Color Cuerpo</label>
                                        <input type="color" class="form-control" name="color_2" id="color_2">                
                                    </div>
                                </section>
                                <section class="col col-sm-4">
                                    <div class="form-group">
                                        <label for="color_3">Color Botones</label>
                                        <input type="color" class="form-control" name="color_3" id="color_3">                
                                    </div>
                                </section>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" id="cont-{{$ser->id}}" name="cont-{{$ser->id}}" placeholder="Cantidad de Mensajes">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <button type="submit" class="btn btn-primary btn-lg float-right"><i class="fas fa-credit-card"></i> Crear</button>
